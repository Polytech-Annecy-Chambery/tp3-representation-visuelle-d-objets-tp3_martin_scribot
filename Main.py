...
def Q3a():
    return Configuration().add(Wall(({'width': 7, 'height': 2.6,                         'thickness': 2, 'color': [0,0,1], 'orientation' : 45, 'position': [0,0,1]})))

def Q4a():
    # Ecriture en utilisant des variables : A compléter
    wall1 = Wall(({'width': 10, 'height': 2.6,'thickness': 1, 'color': [0,0,1], 'orientation' : 0, 'position': [0,0,0]}))
    wall2 = Wall(({'width': 5, 'height': 2.6,'thickness': 1, 'color': [0,0,1], 'orientation' : 90, 'position': [0,0,0]}))
    wall3 = Wall(({'width': 10, 'height': 2.6,'thickness': 1, 'color': [0,0,1], 'orientation' : 180, 'position': [10,5,0]}))
    wall4 = Wall(({'width': 5, 'height': 2.6,'thickness': 1, 'color': [0,0,1], 'orientation' : -90, 'position': [10,5,0]}))  
